...
\begin{frame}{Magnetic field effects}
  ...
  \vspace{-0.6cm}
  \begin{center}
    \phantom{The $\SI{2}{\tesla}$ field proposed in CLD has a \underline{small} effect on the PID performance!}
  \end{center}
\end{frame}
...
\begin{frame}{Magnetic field effects}
  ...
  \vspace{-0.6cm}
  \begin{center}
    The $\SI{2}{\tesla}$ field proposed in CLD has a \underline{small} effect on the PID performance!
  \end{center}
\end{frame}
...
\begin{frame}{Summary and next steps}
  \begin{itemize}
    ...
    \begin{itemize}
      \item{Long term goal: Full simulation of the detector in Geant4}
    \end{itemize}
    \item{Detector R\&D should proceed in parallel to the software studies to verify assumptions, in particular for the SiPM and gas parameters}
  \end{itemize}
  \begin{center}
...
\begin{frame}{Backup: \textbf{A}rray of \textbf{R}ICH \textbf{C}ells}
  \begin{figure}
