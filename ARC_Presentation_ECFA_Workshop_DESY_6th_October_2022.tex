...
\begin{frame}{\textbf{A}rray of \textbf{R}ICH \textbf{C}ells}
  \begin{itemize}
    ...
    \end{itemize}
    \item{Design based on current \href{https://arxiv.org/abs/1911.12230}{CLD experiment} concept}
    \begin{itemize}
...
\begin{frame}{ARC radiators}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item{$C_4F_{10}$ is a greenhouse gas, substitution with xenon is possible}
    \end{itemize}
    \item{Aerogel:}
    \begin{itemize}
      \setlength\itemsep{0.2em}
      \item{Well known from ARICH at Belle}
...
\begin{frame}{Event displays}
  \begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
      \includegraphics[width = 1.0\textwidth]{example-image-a}
    \end{subfigure}
    \caption{\color{red}Some event displays from Roger}
  \end{figure}
\end{frame}
...
\begin{frame}{Examples of photon tracking}
  \begin{figure}
    \centering
    \begin{subfigure}{0.45\textwidth}
...
\begin{frame}{Emission-point uncertainties, mean number of photons}
  \begin{figure}
    ...
    \vspace{-0.2cm}
    \begin{subfigure}{0.35\textwidth}
      \includegraphics[width = 1.0\textwidth]{Plots/MeanNumberOfPhotons.png}
      \caption{Mean number of photons detected}
    \end{subfigure}
    \begin{subfigure}{0.35\textwidth}
      \includegraphics[width = 1.0\textwidth]{Plots/SinglePhotonEmissionPointUncertainties.png}
      \caption{Single photon emission point uncertainty}
    \end{subfigure}%
    \begin{subfigure}{0.35\textwidth}
      \includegraphics[width = 1.0\textwidth]{Plots/TotalEmissionPointUncertainties.png}
      \caption{Total emission point uncertainty}
    \end{subfigure}
    \caption{Projections of $f(\vec{x})$}
  \end{figure}
\end{frame}
...
\begin{frame}{Performance of optimised ARC}
  \begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{Plots/Significance_Mean.png}
    \caption{The pion-kaon (blue) and proton-kaon (red) separation significance in the gas radiator (solid) and aerogel radiator (dashed).}
  \end{figure}
  \vspace{-0.5cm}
  \begin{itemize}
    \setlength\itemsep{1.0em}
    \item{Aerogel provides over $3\sigma$ pion-kaon separation in the range $2$-$\SI{10}{\giga\eV}$, while gas radiator ensures $3\sigma$ separation in the range $10$-$\SI{50}{\giga\eV}$}
  \end{itemize}
\end{frame}
...
\begin{frame}{Performance of optimised ARC}
  \begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{Plots/Significance_Scatter.png}
    \caption{The pion-kaon (blue) and proton-kaon (red) separation significance in the gas radiator (solid) and aerogel radiator (dashed).}
  \end{figure}
  \vspace{-0.5cm}
  \begin{itemize}
...
\begin{frame}{Summary and next steps}
  \begin{itemize}
    ...
    \item{ARC is a low mass cellular PID detector that fits inside a detector for FCC-ee}
    \item{We have developed an optimised layout that satisfies the requirements of flavour physics at the $Z$-pole}
    ...
    \item{Opens up the possibility of a wide range of flavour physics measurements at FCC-ee!}
  \end{itemize}
  \begin{center}
